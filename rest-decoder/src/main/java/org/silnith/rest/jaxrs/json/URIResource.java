...
public class URIResource {
    ...
    public String encodeHierarchical(
        ...
        LOG.trace("entering encodeHierarchical({}, {}, {}, {}, {}, {})", scheme, userInfo, host, port, pathSegments, fragment);
        ...
        LOG.trace("{} returned from encodeHierarchical({}, {}, {}, {}, {}, {})", uriString, scheme, userInfo, host, port, pathSegments, fragment);
        return uriString;
    }
...
//        return Response.ok(opaqueURI).build();
    ...
    private HierarchicalURI decodeHierarchical(final URI uri) {
        ...
        final HierarchicalURI hierarchicalURI = new HierarchicalURI(scheme, userInfo, host, port, pathSegments, queryParams, fragment);
